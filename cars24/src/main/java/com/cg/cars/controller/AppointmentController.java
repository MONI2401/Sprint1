...
public class AppointmentController {
    ...
    public ResponseEntity<Object> getAppointentById(@PathVariable("id") int id) {
        try {
                return new ResponseEntity <> (AppointmentUtils.convertToAppointment(service.getAppointment(id)),
                        HttpStatus.OK);
    ...
    public ResponseEntity < Object > addAppointment(@RequestBody Appointment appointment){
        try
        {
                return new ResponseEntity <  > (AppointmentUtils.convertToAppointment(service.addAppointment(appointment)), HttpStatus.OK);
        }
    ...
    public ResponseEntity < Object > deleteAppointment(@PathVariable("id") int id){
        try {
                return new ResponseEntity<>(AppointmentUtils.convertToAppointment(service.removeAppointment(id)),
                        HttpStatus.OK);
        } catch (AppoitnmentNotFoundException e) {
    ...
    public ResponseEntity < Object > updateAppointment(@RequestBody Appointment appointment){
        try {
                if (AppointmentServiceImpl.isValidAppointment(appointment))
                    return new ResponseEntity <  > (AppointmentUtils.convertToAppointment(

...
public interface IAppointmentService {
    ...
    public static boolean isValidAppointment(Appointment appointment) throws InvalidAppointmentDateException, InvalidAppointmentTimeException
    {
        return IAppointmentService.isValidAppointmentDate(appointment.getPreferredDate()) && IAppointmentService.isValidAppointmentTime(appointment.getPreferredTime()) ;
    }
    ...
    public static boolean isValidInspectionType(String inspectionType) throws InvalidAppointmentInspectionTypeException
    {
